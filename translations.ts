...
export const LANGUAGE: Languages = {
    nl: {
        ...
        contactSubmitted: "Verzonden",
        contactSubmittedNote: "We sturen je zo snel mogelijk een antwoord.",
    ...
    "en-US": {
        ...
        contactSubmitted: "Sent",
        contactSubmittedNote: "We'll send you a response as soon as possible.",
